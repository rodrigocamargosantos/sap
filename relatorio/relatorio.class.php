...
class Relatorio extends RelatorioSQL
{
		...
		foreach($ArrayConv as $RsConv)
		{
			...
			foreach($ArrayC as $RsC)
			{
				...
				foreach($ArrayTP as $RsTP)
				{
					...
					$Teste = 'Convenio: MT01 Tipo: 1';
					
					if(!empty($RsS)){
						$Html.= "<img title='' style='cursor: pointer;' onclick='modalRelatorio(\"".$RsS['id_processamento']."\")' src='".$_SESSION['UrlBaseSite']."icone/icone.img.php?IdIcone=".$RsS['id_icone']."' height='16' width='16' />";
					}else{
						$Html.= "<img title='' src='".$_SESSION['UrlBaseSite']."icone/icone.img.php?IdIcone=8' height='16' width='16' />";
					}
	...
	public function relatorioLegenda()
	{
		...
		{
			$Html .= "<div style='margin:2px; float:left;'>
	...
	public function tituloModal()
	{
     ...
     public function conteudoModal(){
          ...
          if(!empty($Rs['convenio'])){
              $Html.= "<tr>
                             <td width='25%' class='textoTituloGrid' style='text-align: right;'>Convênio:</td>
                             <td width='75%' class='textoGrid'>".$Rs['convenio']."</td>
                        </tr>";
          }		
          if(!empty($Rs['competencia'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Competência:</td>
                              <td width='75%' class='textoGrid'>".$Rs['competencia']."</td>
                         </tr>";
          }		
          if(!empty($Rs['tipo_processamento'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Tipo de Processamento:</td>
                              <td width='75%' class='textoGrid'>".$Rs['tipo_processamento']."</td>
                         </tr>";
          }
          if(!empty($Rs['status'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Status:</td>
                              <td width='75%' class='textoGrid'>".$Rs['status']."</td>
                         </tr>";
          }
          if(!empty($Rs['observacao'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Observação:</td>
                              <td width='75%' class='textoGrid'>".$Rs['observacao']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_previsao_recebimento_arquivo'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Previsão Recebimento Arquivo:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_previsao_recebimento_arquivo']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_recebimento_arquivo'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Recebimento Arquivo:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_recebimento_arquivo']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_previsao_processamento'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Previsão Processamento:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_previsao_processamento']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_processamento'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Processamento:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_processamento']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_previsao_disponibilizacao'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Previsão Disponibilização:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_previsao_disponibilizacao']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_disponibilizacao'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Disponibilização:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_disponibilizacao']."</td>
                         </tr>";
          }
          if(!empty($Rs['tempo_estimado'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Tempo Estimado:</td>
                              <td width='75%' class='textoGrid'>".$Rs['tempo_estimado']."</td>
                         </tr>";
          }
          if(!empty($Rs['tempo_gasto'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Tempo Gasto:</td>
                              <td width='75%' class='textoGrid'>".$Rs['tempo_gasto']."</td>
                         </tr>";
          }
          if(!empty($Rs['liberado_faturamento'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Liberado Faturamento:</td>
                              <td width='75%' class='textoGrid'>".$Rs['liberado_faturamento']."</td>
                         </tr>";
          }
          if(!empty($Rs['dt_liberacao_faturamento'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Data Liberação Faturamento:</td>
                              <td width='75%' class='textoGrid'>".$Rs['dt_liberacao_faturamento']."</td>
                         </tr>";
          }		
          if(!empty($Rs['situacao'])){
               $Html.= "<tr>
                              <td width='25%' class='textoTituloGrid' style='text-align: right;'>Situação:</td>
                              <td width='75%' class='textoGrid'>".$Rs['situacao']."</td>
                         </tr>";
          }
